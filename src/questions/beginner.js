export default [
  ...
  },
  {
    ...
    answers: [
      { id: 'a', value: 'JavaScript does not support asynchronous code.', isCorrect: true },
      { id: 'b', value: "JavaScript does not have type definitions.", isCorrect: false },
      { id: 'c', value: "JavaScript was created in 10 days.", isCorrect: false },
      { id: 'd', value: 'JavaScript can be used as a server language.', isCorrect: false },
    ],
  ...
  },
  {
    ...
    explanation: "To open a url in a new tab you should use:\n%{window.open(url, '_blank');}",
  },
];